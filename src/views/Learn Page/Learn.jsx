          ...
          <div className="trending-section">
            ...
            <div className="learn-desc">
              <p className="learn-para">
                We pare down complex topics to their key practical components, so you gain usable skills in a few hours (instead of weeks or
                months). The courses are provided at no cost to you, and you can now earn certificates.{' '}
