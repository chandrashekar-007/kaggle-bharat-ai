...
export default function SideBar({ children }) {
  ...
  return (
    <div className="contain">
      <div
        className={`sidebar ${isOpening === false || isMenuClicked === false ? 'is-collapsed' : 'is-expanded'} ${isMenuClicked === true ? 'is-opened' : 'is-closed'}`}
      >
        ...
        <div className={`middle-sidebar-content ${isOpening === false ? 'is-hidden' : ''}`}>
          <div className={`sidebar-plus ${isOpening === false ? 'is-hidden' : ''}`}>
            ...
            <div className="sidebar-create">Create</div>
          </div>
        </div>
