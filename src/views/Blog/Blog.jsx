        ...
        <div className="blog-links">
          <div className="links-left-section">
            <div className="buttons-links">
              <Link to="#">
                <div className="first-btn">COMPETITION STORIES</div>
              </Link>
              <Link to="#">
                <div className="second-btn">JOIN A COMPETITION</div>
              </Link>
            </div>
          </div>
        ...
        <div className="blog-main">
          ...
          <div className="blog-main-content">
            ...
            <div className="main-description">
              This post was written by Vladimir Iglovikov, and is filled with advice that he wishes someone had shared when he was active on
              Kaggle.
            </div>
...
const BlogsList = (data) => {
  ...
  return (
    <div className="blog-list">
      ...
      <div className="bloglist-title">{`${title}`.slice(0, 60)}...</div>
      <div className="bloglist-para">{desc}</div>
      <div className="bottom-caption">
        <img src={img7} alt="user-logo" />
        <div className="caption-data">
          <div className="title">Kaggle Team</div>
