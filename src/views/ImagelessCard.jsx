    ...
    <div className="imgless-card">
      <a href="#" className="card-link">
        <div className="card-data">
          <div className="imglesscard-title">Gemini API</div>
          <div>
          ...
          <div className="imglesscard-para">A new family of multimodal models from Google DeepMin</div>
        </div>
      </a>
      <div className="model-rating-section">
        <div className="model-rating">
          <div className="model-rating-icon">
