            ...
            <div className="privacy-container">
                <div className="privacy-content">
                    ...
                    <div className="heading">
                        ...
                        We’ll ask for your consent before using your information for a purpose that isn’t covered in this Privacy Policy. You may, of course, decline to share certain personal information with Kaggle, in which case Kaggle may not be able to provide to you some of the features and functionality found on the Services.
                    </div>
                    <div className="privacy-point-title">Information Kaggle Collects</div>
                    <div className="point-content">
                        We collect information to provide better Services to all our users. When you’re not signed into a Kaggle account, we store the information we collect with unique identifiers tied to the browser, application, or device you’re using. When you’re signed in, we collect information that we store with your Kaggle account.</div>
                    <div className="privacy-point-title italic">Things You Create or Provide to Us</div>
                    <div className="point-content">
                        When you create a Kaggle account, submit competition entries or otherwise use the Services, you provide us with personal information that includes your name and a password. You may also provide your mailing address and home/mobile phone number, or other personal information.<br />
                    ...
                    <div className="point-content">
                        ...
                        And we use your information to make improvements to our Services – for example, to understand and analyze the usage trends and preferences of our Kaggle account members and to improve the way the Services work and look.<br />
                    ...
                    <div className="point-content">
                        When you’re signed into your Kaggle account, you can always review and update information by visiting your account profile.</div>
                    <div className="privacy-point-title italic">Exporting, Removing & Deleting Your Information</div>
                    <div className="point-content">
                        You can export a copy of content in your Kaggle account if you want to back it up or use it with a service outside of Kaggle by <a href="#" className="lined"> contacting us here</a>. You may update, correct, or delete your profile information and preferences at any time by accessing your account settings page or editing your Kaggle account profile through the Services.<br />

                        You can also delete your discussion posts, uploaded datasets, and notebooks by using the available tools in our Services. If desired, you can delete your entire Kaggle account by choosing that option in your account settings page.<br />
                    ...
                    <div className="point-content">
                        When you delete data in your Kaggle account, we immediately start the process of removing it from the product and our systems. First, we aim to immediately remove it from view. For example, if you delete a post you made, we will immediately remove that from the public-facing Kaggle website.<br />
                    ...
                    <div className="point-content">
                        ...
                        Many of our Services let you share information with other people, and you have control over how you share. Any information that you voluntarily choose to include in an area of the Services accessible to other Kaggle members or the public, such as a public profile page or in a forum posting, will be available to other Kaggle members who access that content or the public (as applicable). This also applies to information you choose to make available through features that connect to third party services, if applicable.<br />

                        Also, if you communicate directly with another Kaggle member, any information that you voluntarily choose to include in such a communication with other Kaggle members will be available to such other members. Once you make your information available in any of these ways, it could be collected and used by the recipients without restriction. We urge Kaggle members to exercise common sense, prudence and good judgment about what information to make available to others through the Services.</div>
                    <div className="privacy-point-title italic">
                        When Kaggle Shares Your Information</div>
                    <div className="point-content">
                    ...
                    <div className="point-content">
                        We’ll share personal information outside of Kaggle when we have your consent. For example, if you give us permission to share your information with a third party who may be a prospective employer.</div>
                    <div className="privacy-point-title fade">

                        To operate competitions</div>
                    <div className="point-content">
                        Kaggle may disclose your personal information to the hosts of competitions to enable your participation in the competitions and our operation of the competitions. The terms of that disclosure are covered in the competition rules, which is a contract between you and the competition sponsor.</div>
                    <div className="privacy-point-title fade">
                    ...
                    <div className="point-content">
                        We will share personal information outside of Kaggle if we have a good-faith belief that access, use, preservation, or disclosure of the information is reasonably necessary to:<br />
                        <ul type="circle">
                            <li>
                            ...
                            <li>
                                Protect against harm to the rights, property or safety of Kaggle or our affiliates, our users, or the public as required or permitted by law.</li>
                            <li>
                        ...
                        If Kaggle is involved in a merger, acquisition, or sale of assets, we’ll continue to ensure the confidentiality of your personal information and give affected users notice before personal information is transferred or becomes subject to a different privacy policy.
                    </div>
                    <div className="privacy-point-title ">
                        Our Commitment to Data Security</div>
                    <div className="point-content">
                        Kaggle uses a variety of physical, managerial, and technical safeguards designed to improve the security of our systems and your personal information.<br />

                        If Kaggle learns of a security breach, we will notify you in accordance with applicable law.</div>
                    ...
                    <div className="point-content">
                        Protecting the privacy of children is especially important. For that reason, Kaggle does not knowingly collect or maintain personal information from persons under 13 years old, and no part of the Services is directed to persons under 13. IF YOU ARE UNDER 13 YEARS OF AGE, PLEASE DO NOT USE OR ACCESS THE SERVICES AT ANY TIME OR IN ANY MANNER.<br />

                        If Kaggle learns that personal information of children under 13 years old has been collected on the Services without verifiable parental consent, then Kaggle will take the appropriate steps to delete this information. If you are a parent or guardian and discover that your child under the age of 13 has obtained a user account on the Services, then you may alert Kaggle at <a href="#" className="lined"> Kaggle Support</a> and request that Kaggle delete that child’s personal information from its systems.<br />

                        If you are between the ages of 13 and 16 years old, you may not use the Services until Kaggle has received verifiable parental consent for your use of the Services. If you are between the ages of 13 and 17 years old or under the age of contractual majority in your country, you also may not enter any competitions until Kaggle has received verifiable parental consent for your entry into a specific competition. Please check the eligibility rules for each competition to verify that minors are allowed to participate and ensure that the parental consent form is on file for each competition. More information on the parental consent process can be found at <a href="#" className="lined"> Kaggle Support</a>.</div>
                    <div className="privacy-point-title ">
                    ...
                    <div className="point-content">
                        If European Union (EU) data protection law applies to the processing of your information, you can exercise your right to request access to, update, remove, and restrict the processing of your information. You also have the right to object to the processing of your information or export your information to another service. Please visit <a href="#" className="lined">Kaggle Support</a>  to exercise these rights.<br />

                        If you have any questions, you may contact our data protection office at <a href="#" className="lined"> data-protection-office@kaggle.com.</a> If you have concerns regarding your rights under local law, you can contact your local data protection authority. Kaggle has appointed Google Cloud EMEA Ltd. to act as its local representative under Article 27 of the EU General Data Protection Regulation. Google Cloud EMEA Ltd.’s address is Gordon House, Barrow Street, Dublin 4, Ireland (Registered Number: 660412). Kaggle has appointed Google UK Limited to act as its local representative under Article 27 of the UK General Data Protection Regulation. Google UK Limited&apos;s address is Belgrave House, 76 Buckingham Palace Road, London, SW1W 9TQ, UK (Registered Number: 03977902).<br />
                    ...
                    <div className="point-content">
                        We ask for your agreement to process your information for specific purposes and you have the right to withdraw your consent at any time. You can manage these settings in your Kaggle account.</div>
                    <div className="privacy-point-title fade">
                    ...
                    <div className="point-content">
                        ...
                        <ul type="circle">
                            ...
                            <li>
                                Protecting against harm to the rights, property or safety of Kaggle, our users, or the public as required or permitted by law</li>
                            <li>
                    ...
                    <div className="point-content">
                        If the California Consumer Privacy Act (CCPA) applies to your information, we provide these disclosures and the tools and contact information described in this Privacy Policy so you can exercise your rights to receive information about how Kaggle collects, uses, and discloses your personal information, to request access to and deletion of your information, and not to be discriminated against for exercising your privacy rights. You can exercise your rights by using these tools, which allow you to access, review, update and delete your information, and you may contact us to export and download a copy of it. You can also read more about Kaggle’s data retention periods in the “Data Retention” section, and the process we follow to delete your information.<br />

                        Kaggle does not sell your personal information. We only share your information as described in the “Sharing Your Information” section of this Privacy Policy.<br />
                        ...
                        If you have additional questions or requests related to your rights under the CCPA, you (or your authorized agent) can <a href="#" className="lined">contact Kaggle</a> .
                    ...
                    <div className="point-content">
                        ...
                        For users based in Brazil, the data controller responsible for your information is Kaggle Inc., unless otherwise stated in a service-specific privacy notice. In other words, Kaggle Inc. is responsible for processing your information and for complying with applicable privacy laws.<br />
                        ...
                        <ul type="circle">
                            ...
                            <li>
                                Detecting, preventing, or otherwise addressing fraud, abuse, security, or technical issues with our services</li>
                            <li>
                                Protecting against harm to the rights, property or safety of Kaggle, our users, or the public as required or permitted by law, including disclosing information to government authorities</li>
                            <li>
                                Performing research that improves our services for our users and benefits the public</li>
                            <li>
                    ...
                    <div className="point-content">If you have questions, you can <a href="#" className="lined">contact Kaggle</a> . You can also contact your data protection authority if you have concerns regarding your rights under Brazilian law.</div>
                    <div className="privacy-point-title ">
                    ...
                    <div className="point-content">
                        ...
                        Our amended Privacy Policy will become effective on a going-forward basis as stated in the Terms, except that (i) unless you agree otherwise, we will use your personal information in the manner described in the Privacy Policy in effect when we received that information and (ii) if you do not agree with any changes to the Privacy Policy, you must terminate your Kaggle membership and cease use of the Services. Your continued use of the Services after a revised Privacy Policy has become effective indicates that you have read, understood and agreed to the current version of the Privacy Policy.<br /></div>
                    <div className="privacy-point-title ">Kaggle Contact Information</div>
                    <div className="point-content">Please contact Kaggle with any questions or comments about this Privacy Policy, your personal information, our use and disclosure practices, or your consent choices through <a href="#" className="lined">Kaggle Support</a> .<br />

                        Specific Contact Emails:<br />
                        <ul type="circle">
                            <li>
                                General Privacy: privacy@kaggle.com</li>
                            <li>
                                Data Protection Office: data-protection-office@kaggle.com</li>
                            <li>
                                Security: security@kaggle.com</li>
                            <li>
                                Abuse: abuse@kaggle.com</li>
                        </ul>
                    </div>
                </div>
            </div>
