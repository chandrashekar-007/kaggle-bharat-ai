...
export default function Competitions() {
  ...
  const btnData = [{ btn1: 'Host a competition' }, { searchData: 'Search competitions' }];
  const data = [
    {
      id: 1,
        ...
        <div className="container">
          <div className="trending-section">
            ...
            <div className="trending-cards grid4">
              <div className="text-card">
                <h1 className="text-card-title">New to Kaggle?</h1>
                <p className="text-card-para">These competitons are perfect for newcomers.</p>
              </div>
          ...
          <div className="textdata-section">
            ...
            <div className="textdata-cards grid4">
              <div className="text-card">
                <h1 className="text-card-title">Make Learning Fun</h1>
                ...
                <p className="text-card-para">
                  ...
                  <a href="#" className="lined">
                    {' '}
                    Create a competition or view our library of cloneable competitions.
                  </a>
                </p>
              </div>
              {activeData.map((data) => {
