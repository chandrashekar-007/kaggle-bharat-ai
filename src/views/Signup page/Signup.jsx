    ...
    <section className="login-section">
        ...
        <div className="login-top">
          ...
          <div className="login-sub-head">
            ...
            <div className="choices">
              <NavLink to={'/login'}>
                <div className="signin" value={'1'} onClick={handleClick}>
        ...
        <div className="login-bottom">
          ...
          <div className="login-account">
            <p className="account">
              ...
              <NavLink to="/login" className="lined">
                Sign In
              </NavLink>
            </p>
          </div>
      ...
      <div className="contact-sec">
        <p className="signup-info">
          When you NavLink your Facebook, Google, or Yahoo account, Kaggle collects certain information stored in that account that you have
          configured to make available. By NavLinking your accounts, you authorize Kaggle to access and use your account on the third party
          service in connection with your use of kaggle.com.
        </p>
