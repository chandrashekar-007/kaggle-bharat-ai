        ...
        <div className="docs-content">
          ...
          <a href="#">
            <div className="docs-card">
              ...
              <div className="docs-card-para">
                Explore and run machine learning code with Kaggle Notebooks, a cloud computational environment that enables reproducible and
